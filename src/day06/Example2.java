    ...
    public static void main(String[] args) {    // main start
        ...
        /*
            [ 클래스와 객체 ]
                ...
                2) 객체 종류 : 모든 것들 , 속성과 기능을 정의한다면
                    - 사람(물리) , 주문(논리) , 안경(물리) , 공기(물리) , 강의(논리) 등등
                3) 객체지향 프로그래밍 : 개발자(주체)가 컴퓨터 안에서 대상(객체) 만들기
                4) 클래스 : 객체를 만들기 위한 설계도 , 속성과 기능 코드로 표현
                    - 속성 : 대상의 본질적인 특징/성질/특성            -> 멤버변수
                    - 기능 : 대상의 작동/행위/이벤트                  -> 멤버함수, 메소드(java)
                    * 자바의 모든 코드 컴파일(번역)은 클래스 단위로 컴파일한다. *
                5) 생활속 예시
                    (1) 학생 객체 만들기
                        1. 클래스 정의한다.    즉] 속성과 기능 만들기       -> 특징 , 이벤트 만들기
                            -> 학생에게 속성 부여 : 학번 , 이름 , 학급 , 전화번호
         ...
         */
        // [1] 학생 클래스 만들기 : 클래스는 학생 객체를 만들기 위한 속성과 기능을 정의하는 곳.
        ...
        // * 객체를 저장하는 변수의 타입은 객체의 클래스/타입으로 선언한다.
        Student s1 = new Student();
        // [4] 생성된 객체 정보 호출
        System.out.println(s1); // day06.Student@119d7047 : 객체 주소(컴퓨터내 메모리 위치)값이 반환된다.
        // [5] 객체내 멤버변수 호출
        System.out.println(s1.studentName); // null : 객체내 멤버변수에 초기값이 없으면 기본값이 대입된다.
        // [6] 객체내 멤버변수 값 수정
        s1.studentName = "유재석";
        System.out.println(s1.studentName);
        // [7] 객체내 멤버변수 삭제/추가 불가능 : 실행 도중에 클래스 정보를 수정할 수 ㅇ벗다.

        // [8] 붕어빵 객체 만들기
            // 1) 붕어빵 객체 만들기 위한 붕어빵(틀) 클래스/설계도 만들기
            // - 붕어빵 장사를 하기 전에, 붕어빵 주인은 붕어빵틀(기계) 구매한다.
            // 2) 붕어빵 객체 만들기
            // - 손님이 팥2개, 슈크림1개 주세요.
            붕어빵틀 빵1 = new 붕어빵틀();
            빵1.내용물 = "팥";
            ...
            붕어빵틀[] 빵봉지 = { 빵1 , 빵2 , 빵3 };  // 붕어빵 넣어주기
                // * 서로 다른 속성/타입들을 데이터를 묶음 -> 객체화 , 내용물/가격 다름 - > 객체
                // & 서로 같은 속성/타입들의 데이터를 묶음 -> 배열화 , 빵1 , 빵2 , 빵3 -> 배열

    } // main end
} // Example2 class end

class Student {  // 클래스란? 객체를 만드는 코드가 아닌, 객체를 만들기 위해 객체내 필요한 속성과 기능을 설계/정의 student class start
