...
class miniArrayList< E > {
    E[] data = (E[])new Object[10]; // E[]으로 강제타입변환해서 사용
} // class end

// [4]
// 관례적으로 제네릭이름은 대문자 1개를 사용
class Dto< T , E>{
...
public class Example3 {
    public static void main(String[] args) {
        ...
        /*
            [ 제네릭 타입 ]
                1. 정의 : 여러가지 타입에서 동작할 수 있도록 만든 키워드/문법
        ...
        */
        ...
        // [3] 제네릭 타입
        Box < String > box3 = new Box<>();  // 객체 선언
        // Box < int > box4 = new Box<>();
        // *기본타입으로 제네릭 타입 사용 불가능
        Box < Integer > box4 = new Box < Integer >();
        // * 뒤 생성자에는 제네릭 타입 생략 가능
        box3.content = "자바";
        box4.content = 200;
