...
public class Example1 { // class start
    public static void main(String[] args) { // main start
        ...
        동물 animal = new 동물();
        animal.name = "강아지";
        animal.show();      // show 함수 가져오기 : 강아지 출력

        // [2] 조류 클래스로 객체 1개 , 조류의 부모 -> 동물
        조류 bird = new 조류();
        // -> extends란? 상위클래스의 멤버변수/메소드를 하위클래스가 사용
        bird.name = "비둘기";    // 조류 클래스에 존재하지 않는 멤버변수
        bird.show();            // 조류 클래스에 존재하지 않는 메소드

        // [3] 참새 클래스로 객체 1개 , 참새의 부모 -> 조류 -> 동물
        참새 sparrow = new 참새();
        // -> 상위클래스의 상위클래스로부터 멤버변수 메소드 상속 받음
        sparrow.name = "참새1";
        sparrow.show();
...
//        조류 bird3 = animal;    // 역시 오류 발생. 부모는 자식을 모르기 때문. 자식이 부모를 상속자로 extends 하는 구조.
