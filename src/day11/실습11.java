...
*/
        ...
        ArrayList<String> skillStack = new ArrayList<>();
        skillStack.add("자바");
        skillStack.add("파이썬");
        skillStack.add("C++");
        skillStack.add(1, "자바스크립트");
...
*/
        ...
        Book b1 = new Book("연금술사", "파울로코엘료");
        Book b2 = new Book("강철의연금술사", "아라카와히로무");
        Book b3 = new Book("코스모스", "칼세이건");
        library.add(b1);
        library.add(b2);
        library.add(b3);
...
*/
        ...
        for (; ; ) {
            System.out.println("리스트에 저장할 문자를 입력하세요.");
            String word = scan.nextLine();  // 단어 입력하게 하기
            printer.add(word);              // 입력한 단어 프린터에 집어넣기
            if (word.equals("종료") || word.equals("quit")) {
                System.out.println("제목 : " +printer);
                break;
            }
        }
