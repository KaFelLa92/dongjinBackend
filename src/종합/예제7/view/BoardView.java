package 종합.예제7.view; // package name
...
public class BoardView { // class start
    ...
    // 원래는 private BoardController boardController = new BoardController();인데,
    // 싱글톤은 미리 만들어둔 객체를 꺼내오는 것이라, 겟인스턴스 메소드를 쓴다.
    ...
    public void boardWrite() {
        ...
        // 입력받은 값들을 controller에게 전달후 반환값 저장
        if (result) {
